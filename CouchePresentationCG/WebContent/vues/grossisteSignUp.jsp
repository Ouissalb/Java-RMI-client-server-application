              ...
              <div class="indent">
				...
				<div class="Gcontainer">
					...
					<div class="login-container">
					  <form data-ajax="false"  action="<%=request.getContextPath()%>/signup" method="post">
					    ...
					    <input type="text" id="lname" name="nom" placeholder="Password">
					    
					    <label for="lname">Coordonnees</label>
					    <input type="text" id="lname" name="coordonnees" placeholder="Password">
