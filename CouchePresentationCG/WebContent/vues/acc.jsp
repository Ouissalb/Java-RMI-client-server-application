              ...
              <div class="indent">
                <div class="indent1">
                  ...
                  <div class="clientG">
                  	 ...
                  	 &nbsp &nbsp &nbsp &nbsp<a href="<%=request.getContextPath()%>/chercherArticle" class="myButton">Un client</a> &nbsp &nbsp &nbsp &nbsp
                  	<a href="<%=request.getContextPath()%>/LoginG" class="myButton">Un grossiste</a>
                  </div>
                  <br><br>
